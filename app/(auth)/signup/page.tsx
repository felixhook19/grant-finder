    ...
    <div className="min-h-screen bg-midnight flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-slate">Find grants your business actually qualifies for</p>
        </div>
        ...
        <div className="bg-ink/50 border border-white/5 rounded-2xl p-8">
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-spark text-midnight font-semibold py-3 rounded-xl hover:bg-spark/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-center text-slate text-sm mt-6">
            ...
            <Link href="/login" className="text-spark hover:underline">Sign in</Link>
          </p>
        </div>

        <p className="text-center text-slate/50 text-xs mt-6">
          By signing up you agree to our{' '}
          <Link href="/terms" className="hover:text-slate">Terms</Link> and{' '}
          <Link href="/privacy" className="hover:text-slate">Privacy Policy</Link>
        </p>
      </div>
    </div>
  )
